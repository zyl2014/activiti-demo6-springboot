...
//        ProcessEngine engine = ProcessEngines.getDefaultProcessEngine();
        ...
        Deployment dep = rs.createDeployment().addClasspathResource("/Users/zhiyonglin/eclipse-workspace/workFlow/bpmn/OperationAndMaintenanceProcess.bpmn20.xml").deploy();
